...
// function uploadVideoNugget(e, index) {

//        let labelCont =  e.target.closest('.labelVidNugget')
//        labelCont.style.opacity = 0.5
...
//               setVideoNugget({ ...videoNugget, progress : progress })
//            }

//        } )
//        .then((e)=>{
//               setVideoNugget({ ...videoNugget, estado: "subido"   })
...
// }
       ...
       // let filterNumbers = nuggets.filter(nugget => nugget.id == index);
  function render(){
